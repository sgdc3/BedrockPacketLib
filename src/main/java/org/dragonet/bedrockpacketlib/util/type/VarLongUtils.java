...
public class VarLongUtils {
    ...
    public long readFromStream(InputStream inputStream) throws IOException {
        return VarTypeUtils.decodeZigZag64(UnsignedVarLongUtils.readFromStream(inputStream));
    }

    public void writeToStream(OutputStream outputStream, long value) throws IOException {
        UnsignedVarLongUtils.writeToStream(outputStream, VarTypeUtils.encodeZigZag64(value));
    }
