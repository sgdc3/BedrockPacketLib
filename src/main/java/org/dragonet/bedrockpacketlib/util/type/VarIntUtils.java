...
public class VarIntUtils {
    ...
    public int readFromStream(InputStream inputStream) throws IOException {
        return VarTypeUtils.decodeZigZag32(UnsignedVarIntUtils.readFromStream(inputStream));
    }

    public void writeToStream(OutputStream outputStream, int value) throws IOException {
        UnsignedVarIntUtils.writeToStream(outputStream, VarTypeUtils.encodeZigZag32(value));
    }
