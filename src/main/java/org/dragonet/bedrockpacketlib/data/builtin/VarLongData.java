...
import org.dragonet.bedrockpacketlib.util.type.VarLongUtils;

import java.io.ByteArrayInputStream;
import java.io.ByteArrayOutputStream;
import java.io.IOException;

public class VarLongData extends AbstractBedrockPacketData<Long> {

    @Override
    protected void writeToStream(ByteArrayOutputStream outputStream, Long value) throws IOException {
        VarLongUtils.writeToStream(outputStream, value);
    }

    @Override
    protected Long readFromStream(ByteArrayInputStream inputStream) throws IOException {
        return VarLongUtils.readFromStream(inputStream);
    }
